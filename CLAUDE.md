...
| **Nexus** | `/nexus` (SPA), `/nexus/u/[username]` (profil) | `api/nexus/*` (feed/profile/follows/report) | 🟡 Core real | Feed/post/like/save/izoh/follow + shoppable + **profil** (postlar/follower/following + kuzatish) + shikoyat real. Qolgan ~55 komponent (stories/video/live/media/DM) mock |
