                            ...
                            {filtered.length === 0 && (
                                <div className="flex flex-col items-center justify-center py-16 gap-3">
                                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center"
                                        ...
                                        <ShoppingBag className="w-6 h-6" style={{ color: "rgba(43,62,232,0.40)" }} />
                                    </div>
                                    <p className="text-sm font-bold text-white">Mahsulot topilmadi</p>
                                    <p className="text-[11px]" style={{ color: "rgba(80,100,150,0.70)" }}>Boshqa katagory yoki qidiruv so'zini sinab ko'ring</p>
                                </div>
                            )}
