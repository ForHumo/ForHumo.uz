                ...
                <div className="flex-1 overflow-y-auto p-3" style={{ scrollbarWidth: "none" }}>
                    {tab === "list" && (
                        loading ? (
                            ...
                            <>
                                <button onClick={() => setTab("create")}
                                    className="w-full mb-2 h-10 rounded-xl text-sm font-black text-[var(--nx-text)] flex items-center justify-center gap-2"
                                    style={{ background: "var(--nx-accent)" }}>
                                            ...
                                            <div className="flex -space-x-2">
                                                {l.members.slice(0, 3).map(m => (
                                                    <img key={m.id} src={m.image ?? "/logos/forhumo.png"} alt=""
                                                        ...
                                                        style={{ border: "2px solid var(--nx-bg)" }} />
                                                ))}
                                            </div>
                                    ...
                                    return (
                                        <button key={c.id}
                                            ...
                                            {on && <div className="w-5 h-5 rounded-full flex items-center justify-center"
                                                style={{ background: "var(--nx-accent)" }}>
                                                <span className="text-[10px] font-black text-[var(--nx-text)]">✓</span>
                                            </div>}
                                        </button>
                                    );
                                })}
