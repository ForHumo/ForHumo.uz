        ...
        <>
            ...
            <div className="fixed inset-x-0 bottom-0 z-[80] flex flex-col rounded-t-3xl overflow-hidden md:inset-x-auto md:inset-y-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[440px] md:rounded-3xl"
                ...
                <div className="flex justify-center pt-3 pb-1 flex-shrink-0">
                    <div className="w-10 h-1 rounded-full" style={{ background: "rgb(var(--nx-accent-rgb) / 0.30)" }} />
                </div>
                    ...
                    {options.map(opt => {
                        ...
                        return (
                            <button key={opt.id} onClick={opt.run}
                                ...
                                style={{ background: "rgb(var(--nx-accent-rgb) / 0.07)", border: "1px solid rgb(var(--nx-accent-rgb) / 0.15)" }}>
                ...
                <div className="px-5 pb-6">
                    <div className="flex items-center gap-3 px-3 py-3 rounded-2xl" style={{ background: "rgb(var(--nx-accent-rgb) / 0.08)", border: "1px solid rgb(var(--nx-accent-rgb) / 0.18)" }}>
                        ...
                        <button onClick={copyLink}
                            ...
                            style={copied
                                ? { background: "rgb(var(--nx-accent-rgb) / 0.15)", color: "var(--nx-accent)", border: "1px solid rgb(var(--nx-accent-rgb) / 0.30)" }
                                : { background: "rgb(var(--nx-accent-rgb) / 0.15)", color: "white", border: "1px solid rgb(var(--nx-accent-rgb) / 0.30)" }}>
